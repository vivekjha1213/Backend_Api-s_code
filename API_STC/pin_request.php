	...
	$msisdn1=$msisdn;
        ...
        if ($msisdn1 != '') {
           ...
           // $arrayData['trackingId'] = $trackingid;
			...
			//$sql_subscription = "INSERT INTO `saudi_arabia_timwe_stc_pin_request`(`msisdn`, `status`) VALUES ( '$msisdn1','$message')";
		...
		$message='Already Subscribed msisdn';
                ...
                $sql_subscription = "INSERT INTO `saudi_arabia_timwe_stc_pin_request`(`cid`,`msisdn`,`subscriptionResult`,`message`,`date_india`, `date_saudi_arabia`) VALUES ( '$cid','$msisdn1','$subscriptionResult','$message','$date_india','$date_saudi_arabia')";
                mysql_query($sql_subscription);
...
if($service=="STC_INFOCELL")
{
    ...
    $fp = fopen('STC_infocell_Game2play_pin_request_log'.date("Y-m-d"), 'a');
    ...
    $raw_data=array(
      ...
      $reason=$response['result']['response']; 
       ...
       if ($code=="1") {
         $sql="INSERT INTO  `game2play_stc_infocell_pin_request` (`cid`,`msisdn`,`subscriptionResult`,`status`,`date`,`data`) VALUES('".$clickid."','".$msisdn."','".$result."','".$reason."','".$time_india."','".$a."')";
