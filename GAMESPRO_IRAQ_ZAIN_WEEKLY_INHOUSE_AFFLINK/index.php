...
<head>
  ...
  <title>GAMESPRO_IRAQ_ZAIN_WEEKLY_INHOUSE_AFFLINK</title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(GAMESPRO_IRAQ_ZAIN_WEEKLY_INHOUSE_AFFLINK conversion tracker)</h2>
  <p>GAMESPRO_IRAQ_ZAIN_WEEKLY_INHOUSE_AFFLINK</p>
   <div class="text-right">
      ...
      <div class="black_box">
<a class="gold_text" href="http://beyondhealth.info/INAPP_API_REPORT/GAMESPRO_IRAQ_ZAIN_WEEKLY_INHOUSE_AFFLINK?date=<?=date("Y-m-d")?>">Refresh</a>
</div>
...
<div id="today_report">
<?php
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0133' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `in_app_pin_verify`  where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0133'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM in_app_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0133'";
...
<br>
<?php
$sql1="SELECT * From in_app_pin_verify where date(date) between '$today_date' and '$today_date' and serviceId='ARSH0133' order by id desc";
//exit();
//exit();
