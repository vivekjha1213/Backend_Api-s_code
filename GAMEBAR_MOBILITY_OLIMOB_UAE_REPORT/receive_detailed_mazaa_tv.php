...
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$from' and '$to' and serviceId='ARSH0050' group by status";
...
<br>
<?php
 $sql1="SELECT * From in_app_pin_verify where DATE(date) between '$from' and '$to' and serviceId='ARSH0050' order by date desc";
//exit();
//exit();
