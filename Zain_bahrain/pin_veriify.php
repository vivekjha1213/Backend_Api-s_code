...
fwrite($fp,"\n $time_india_one Received $msisdn with cid $cid server $server\n");
   ...
   $url="http://54.173.65.220/nz-apis/unified/inapp/clientactivity?doaction=CONFIRMPIN&opco=batelco&service=GC&msisdn=$msisdn&channel=INAPP&source=digifish&amount=0.875&ip=$ip&useragent=$server1&OTP=$pin&nzuname=digifish&nzpwd=$pswd";                            
