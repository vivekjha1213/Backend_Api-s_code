...
<br>
<?php
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$from' and '$modified_to' and serviceId='ARSH0121' group by status";
//exit();
...
<?php
    ...
    <!-- //CODE FOR CR -->
    <?php
    $sql="SELECT  count(distinct msisdn) as counter  FROM `in_app_pin_verify`  where DATE(date) between '$from' and '$modified_to' and serviceId='ARSH0121'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM in_app_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$from' and '$modified_to' and serviceId='ARSH0121'";
...
<br>
<?php
$sql1="SELECT * From in_app_pin_verify where date(date) between '$from' and '$modified_to' and serviceId='ARSH0121' order by id desc";
//exit();
//exit();
