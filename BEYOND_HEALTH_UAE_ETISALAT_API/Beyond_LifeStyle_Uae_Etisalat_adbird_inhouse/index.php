...
<head>
  ...
  <title>Beyond_LifeStyle_Uae_Etisalat_adbird_inhouse</title>
  <meta charset="utf-8">
...
<body>
<div class="container">
  <h2>REPORT(Beyond_LifeStyle_Uae_Etisalat_adbird_inhouse conversion tracker)</h2>
  <p>Beyond_LifeStyle_Uae_Etisalat_adbird_inhouse</p>
   <div class="text-right">
      ...
      <div class="black_box">
<a class="gold_text" href="http://beyondhealth.info/INAPP_API_REPORT/Beyond_LifeStyle_Uae_Etisalat_adbird_inhouse?date=<?=date("Y-m-d")?>">Refresh</a>
</div>
...
<div id="today_report">
<?php
$sql3="SELECT status,count(status) as counter From in_app_pin_verify where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0100' group by status";
...
<?php
    ...
    $sql="SELECT  count(distinct msisdn) as counter  FROM `in_app_pin_verify`  where DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0100'";
    $sql2="SELECT  count(distinct msisdn) as counter  FROM in_app_pin_verify  where `status` IN ('PASSED', 'BLOCK') AND DATE(date) between '$today_date' and '$today_date' and serviceId='ARSH0100'";
...
<br>
<?php
$sql1="SELECT * From in_app_pin_verify where date(date) between '$today_date' and '$today_date' and serviceId='ARSH0100' order by id desc";
//exit();
//exit();
