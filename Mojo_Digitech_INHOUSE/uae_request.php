...
function start_first($phone_no, $clickid)
{
    ...
    if ($response == "pin_sent") {
        ...
        // $sql_subscription = "INSERT INTO `beyondlifestyle_uae_alt_pin_request`(`cid`,`msisdn`,`response`, `status`,`date_india`,`tid`) VALUES ('$cid', '$msisdn','$response','$status','$date_india','$token')";
        // mysql_query($sql_subscription);
        ...
        // fclose($fp);
        echo json_encode(array('errorMessage' => 'Success Message String', 'response' => 'SUCCESS'));
